...
using ILCompiler.DependencyAnalysis.RiscV32;
...
namespace ILCompiler.DependencyAnalysis
{
    ...
    {
        protected Register GetContextRegister(ref /* readonly */ RiscV32Emitter encoder)
        {
        ...
        protected void EmitDictionaryLookup(NodeFactory factory, ref RiscV32Emitter encoder, Register context, Register result, GenericLookupResult lookup, bool relocsOnly)
        {
        ...
        protected sealed override void EmitCode(NodeFactory factory, ref RiscV32Emitter encoder, bool relocsOnly)
        {
        ...
        protected virtual void EmitLoadGenericContext(NodeFactory factory, ref RiscV32Emitter encoder, bool relocsOnly)
        {
    ...
    {
        protected override void EmitLoadGenericContext(NodeFactory factory, ref RiscV32Emitter encoder, bool relocsOnly)
        {
