...
#if defined(TARGET_ARM) || defined(TARGET_ARM64) || defined(TARGET_RISCV32) || defined(TARGET_RISCV64) || defined(TARGET_LOONGARCH64)
...
#elif defined(TARGET_ARM) || defined(TARGET_ARM64) || defined(TARGET_RISCV32) || defined(TARGET_RISCV64) || defined(TARGET_LOONGARCH64)
