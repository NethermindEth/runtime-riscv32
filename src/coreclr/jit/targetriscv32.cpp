...
const char*            Target::g_tgtCPUName           = "riscv32";
...
//-----------------------------------------------------------------------------
// RiscV32Classifier:
//   Construct a new instance of the RISC-V 32 ABI classifier.
//
// Parameters:
//   info - Info about the method being classified.
//
RiscV32Classifier::RiscV32Classifier(const ClassifierInfo& info)
    : m_info(info)
...
//-----------------------------------------------------------------------------
// Classify:
//   Classify a parameter for the RISC-V 32 ABI.
//
// Parameters:
...
//
ABIPassingInformation RiscV32Classifier::Classify(Compiler*    comp,
                                                  var_types    type,
