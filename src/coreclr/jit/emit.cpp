...
void emitter::dispIns(instrDesc* id)
{
    ...
    NYI_RISCV32("Not used on RISCV32.");
}
...
void emitter::emitCheckFuncletBranch(instrDesc* jmp, insGroup* jmpIG)
{
    ...
    // TODO-RISCV32: support idDebugOnlyInfo.
...
#elif defined(TARGET_LOONGARCH64) || defined(TARGET_RISCV32) || defined(TARGET_RISCV64)
                    // For LoongArch64, RiscV32 and RiscV64 `emitFwdJumps` is always false.
                    unreached();
#else
#error Unsupported or unset target architecture
#endif
...
regMaskTP emitter::emitGetGCRegsKilledByNoGCCall(CorInfoHelpFunc helper)
{
    ...
    switch (helper)
    {
        ...
        case CORINFO_HELP_PROF_FCN_TAILCALL:
            ...
            break;
#endif // !defined(TARGET_LOONGARCH64) && !defined(TARGET_RISCV32) && !defined(TARGET_RISCV64)
