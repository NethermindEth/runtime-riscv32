...
// The RISCV32 instructions are all 32 bits in size.
...
// Emit the 32-bit RISCV32 instruction 'code' into the 'dst'  buffer
...
enum EmitCallType
{
    ...
    // However, RISCV32 has a much reduced instruction set, and so the RISCV32 emitter only
    ...
    // and know why they are unavailable on RISCV32), while making it easier to stay
