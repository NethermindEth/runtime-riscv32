...
XX                                                                           XX
XX             Lowering for RISCV32 common code                              XX
XX                                                                           XX
XX  This encapsulates common logic for lowering trees for the RISCV32        XX
...
#ifdef TARGET_RISCV32 // This file is ONLY used for RISCV32 architectures
...
{
    // TODO-RISCV32: using B/BL for optimization.
    return false;
}
...
//
// TODO-RISCV32-CQ: recognize GT_MULs that can be turned into MUL_LONGs,
...
GenTree* Lowering::LowerJTrue(GenTreeOp* jtrue)
{
    ...
    {
        // We do not expect any other relops on RISCV32
    ...
    // for RISCV32's compare and condition-branch instructions,
...
void Lowering::ContainBlockStoreAddress(GenTreeBlk* blkNode, unsigned size, GenTree* addr, GenTree* addrParent)
{
    ...
    // TODO-RISCV32: not including the ldptr and SIMD offset which not used right now.
...
{
    NYI_RISCV32("IsValidConstForMovImm");
    return false;
}
...
{
    NYI_RISCV32("LowerHWIntrinsicCmpOp");
}
...
{
    NYI_RISCV32("LowerHWIntrinsicCreate");
}
...
{
    NYI_RISCV32("LowerHWIntrinsicDot");
}
...
{
    // There are no contained operands for RISCV32.
}
...
#ifdef FEATURE_SIMD
    NYI_RISCV32("ContainCheckIndir-SIMD");
#endif // FEATURE_SIMD
...
{
    noway_assert(!"GT_SELECT nodes are not supported on riscv32");
}
...
{
    NYI_RISCV32("ContainCheckHWIntrinsic");
}
#endif // FEATURE_HW_INTRINSICS
