...
// TODO-RISCV32-CQ: Update when it supports c and other extensions
...
constexpr CorDebugRegister g_JITToCorDbgReg[] =
{
    ...
    REGISTER_RISCV32_S8,
    REGISTER_RISCV32_S9,
    REGISTER_RISCV32_S10,
    REGISTER_RISCV32_S11,
    REGISTER_RISCV32_T3,
    REGISTER_RISCV32_T4,
    REGISTER_RISCV32_T5,
    REGISTER_RISCV32_T6,
...
inline BOOL CompareControlRegisters(const DT_CONTEXT * pCtx1, const DT_CONTEXT * pCtx2)
{
    ...
    // TODO-RISCV32: Sort out frame registers
...
inline void CORDbgAdjustPCForBreakInstruction(DT_CONTEXT* pContext)
{
    ...
    // RISCV32 appears to leave the PC at the start of the breakpoint.
    return;
}
