...
elseif (CLR_CMAKE_TARGET_ARCH_ARM)
  ...
  add_definitions(-DFEATURE_EMULATE_SINGLESTEP)
elseif (CLR_CMAKE_TARGET_ARCH_RISCV64 OR CLR_CMAKE_TARGET_ARCH_RISCV32)
  add_definitions(-DFEATURE_EMULATE_SINGLESTEP)
  add_compile_definitions($<$<NOT:$<BOOL:$<TARGET_PROPERTY:IGNORE_DEFAULT_TARGET_ARCH>>>:FEATURE_MULTIREG_RETURN>)
...
if(FEATURE_EVENT_TRACE AND NOT CLR_CMAKE_TARGET_ARCH_RISCV32)
...
endif(FEATURE_EVENT_TRACE AND NOT CLR_CMAKE_TARGET_ARCH_RISCV32)
if(FEATURE_GDBJIT)
...
if (CLR_CMAKE_TARGET_ARCH_AMD64 OR CLR_CMAKE_TARGET_ARCH_ARM64 OR CLR_CMAKE_TARGET_ARCH_LOONGARCH64 OR CLR_CMAKE_TARGET_ARCH_RISCV32 OR CLR_CMAKE_TARGET_ARCH_RISCV64)
   add_compile_definitions(FEATURE_ON_STACK_REPLACEMENT)
endif (CLR_CMAKE_TARGET_ARCH_AMD64 OR CLR_CMAKE_TARGET_ARCH_ARM64 OR CLR_CMAKE_TARGET_ARCH_LOONGARCH64 OR CLR_CMAKE_TARGET_ARCH_RISCV32 OR CLR_CMAKE_TARGET_ARCH_RISCV64)
...
function(set_target_definitions_to_custom_os_and_arch)
  ...
  elseif((TARGETDETAILS_ARCH STREQUAL "riscv32"))
    target_compile_definitions(${TARGETDETAILS_TARGET} PRIVATE TARGET_RISCV32)
    target_compile_definitions(${TARGETDETAILS_TARGET} PRIVATE FEATURE_MULTIREG_RETURN)
