...
uint64_t GetPC(void* context)
{
    ...
    uint32_t& NATIVE_CONTEXT::Ra() { return (uint32_t&)MCREG_Ra(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::Sp() { return (uint32_t&)MCREG_Sp(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::Gp() { return (uint32_t&)MCREG_Gp(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::Tp() { return (uint32_t&)MCREG_Tp(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::T0() { return (uint32_t&)MCREG_T0(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::T1() { return (uint32_t&)MCREG_T1(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::T2() { return (uint32_t&)MCREG_T2(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::Fp() { return (uint32_t&)MCREG_Fp(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::S1() { return (uint32_t&)MCREG_S1(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::A0() { return (uint32_t&)MCREG_A0(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::A1() { return (uint32_t&)MCREG_A1(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::A2() { return (uint32_t&)MCREG_A2(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::A3() { return (uint32_t&)MCREG_A3(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::A4() { return (uint32_t&)MCREG_A4(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::A5() { return (uint32_t&)MCREG_A5(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::A6() { return (uint32_t&)MCREG_A6(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::A7() { return (uint32_t&)MCREG_A7(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::S2() { return (uint32_t&)MCREG_S2(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::S3() { return (uint32_t&)MCREG_S3(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::S4() { return (uint32_t&)MCREG_S4(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::S5() { return (uint32_t&)MCREG_S5(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::S6() { return (uint32_t&)MCREG_S6(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::S7() { return (uint32_t&)MCREG_S7(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::S8() { return (uint32_t&)MCREG_S8(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::S9() { return (uint32_t&)MCREG_S9(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::S10() { return (uint32_t&)MCREG_S10(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::S11() { return (uint32_t&)MCREG_S11(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::T3() { return (uint32_t&)MCREG_T3(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::T4() { return (uint32_t&)MCREG_T4(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::T5() { return (uint32_t&)MCREG_T5(ctx.uc_mcontext); }
    uint32_t& NATIVE_CONTEXT::T6() { return (uint32_t&)MCREG_T6(ctx.uc_mcontext); }
