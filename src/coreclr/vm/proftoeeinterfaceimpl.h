...
#if defined(UNIX_AMD64_ABI) || defined(TARGET_ARM64) || defined(TARGET_RISCV32) || defined(TARGET_RISCV64) || defined(TARGET_LOONGARCH64)
    UINT64       m_bufferPos;

#if defined(UNIX_AMD64_ABI) || defined(TARGET_RISCV32) || defined(TARGET_RISCV64)
...
#endif // UNIX_AMD64_ABI || TARGET_ARM64 || TARGET_RISCV32 || TARGET_RISCV64 || TARGET_LOONGARCH64
