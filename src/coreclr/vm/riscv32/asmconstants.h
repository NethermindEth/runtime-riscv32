...
#define SIZEOF__ArgumentRegisters 0x20
ASMCONSTANTS_C_ASSERT(SIZEOF__ArgumentRegisters == sizeof(ArgumentRegisters))

// 8*8=0x40, fa0-fa7
#define SIZEOF__FloatArgumentRegisters 0x20
...
#define CallDescrData__pArgumentRegisters       0x8
#define CallDescrData__pFloatArgumentRegisters  0xc
...
#define LazyMachState_captureSp     (MachState__isValid+4) // padding for alignment
...
#define MethodTable__m_ElementType     DBG_FRE(0x24, 0x30)
...
#define MethodDesc_ALIGNMENT_SHIFT           2
...
#define                OFFSETOF__DynamicStaticsInfo__m_pMethodTable 0x8
ASMCONSTANTS_C_ASSERT(OFFSETOF__DynamicStaticsInfo__m_pMethodTable
                    == offsetof(DynamicStaticsInfo, m_pMethodTable));

#define                OFFSETOF__DynamicStaticsInfo__m_pNonGCStatics 0x4
...
#define SIZEOF__PROFILE_PLATFORM_SPECIFIC_DATA  0xA8
ASMCONSTANTS_C_ASSERT(SIZEOF__PROFILE_PLATFORM_SPECIFIC_DATA == (sizeof(PROFILE_PLATFORM_SPECIFIC_DATA)+8))
ASMCONSTANTS_C_ASSERT((SIZEOF__PROFILE_PLATFORM_SPECIFIC_DATA & 0xf) == 8)

#define PROFILE_PLATFORM_SPECIFIC_DATA__argumentRegisters 8
#define PROFILE_PLATFORM_SPECIFIC_DATA__functionId 40
#define PROFILE_PLATFORM_SPECIFIC_DATA__floatArgumentRegisters 44
#define PROFILE_PLATFORM_SPECIFIC_DATA__probeSp 76
#define PROFILE_PLATFORM_SPECIFIC_DATA__profiledSp 80
#define PROFILE_PLATFORM_SPECIFIC_DATA__hiddenArg 84
#define PROFILE_PLATFORM_SPECIFIC_DATA__flags 88
