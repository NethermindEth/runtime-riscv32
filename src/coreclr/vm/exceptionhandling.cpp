...
#endif // TARGET_ARM || TARGET_ARM64 || TARGET_X86 || TARGET_LOONGARCH64 || TARGET_RISCV32 || TARGET_RISCV64
...
#elif defined(HOST_ARM)
        pvRegDisplay->pCurrentContext->Lr = GetIP(pvRegDisplay->pCurrentContext);
#elif defined(HOST_RISCV32) || defined(HOST_RISCV64) || defined(HOST_LOONGARCH64)
