...
elseif(TARGET_ARCH_NAME STREQUAL "riscv32")
  ...
  if(EXISTS ${CROSS_ROOTFS}/usr/lib/gcc/riscv32-alpine-linux-musl)
    set(TOOLCHAIN "riscv32-alpine-linux-musl")
  else()
    set(TOOLCHAIN "riscv32-linux-gnu")
    include_directories(SYSTEM ${CROSS_ROOTFS}/usr/include/c++/13)
    include_directories(SYSTEM ${CROSS_ROOTFS}/usr/include/c++/13/riscv32-buildroot-linux-gnu)
    if(TIZEN)
      set(TIZEN_TOOLCHAIN "riscv32-tizen-linux-gnu")
    endif()
  endif()
...
elseif(TARGET_ARCH_NAME STREQUAL "x86")
  ...
  message(FATAL_ERROR "Arch is ${TARGET_ARCH_NAME}. Only arm, arm64, armel, armv6, loongarch64, ppc64le, riscv32, riscv64, s390x, x64 and x86 are supported!")
endif()
...
if(TARGET_ARCH_NAME MATCHES "^(arm|armel|riscv32)$")
  if(TIZEN)
...
if((TARGET_ARCH_NAME MATCHES "^(arm|arm64|armel|armv6|loongarch64|ppc64le|riscv32|riscv64|s390x|x64|x86)$" AND NOT ANDROID AND NOT FREEBSD) OR ILLUMOS OR HAIKU)
