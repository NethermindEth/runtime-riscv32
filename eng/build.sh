...
usage()
{
  ...
  echo "  --arch (-a)                     Target platform: x86, x64, arm, armv6, armel, arm64, loongarch64, riscv32, riscv64, s390x, ppc64le or wasm."
...
while [[ $# > 0 ]]; do
  ...
  case "$opt" in
     ...
     -arch|-a)
      ...
      case "$passedArch" in
        x64|x86|arm|armv6|armel|arm64|loongarch64|riscv32|riscv64|s390x|ppc64le|wasm)
          arch=$passedArch
          ;;
        *)
          echo "Unsupported target architecture '$2'."
          echo "The allowed values are x86, x64, arm, armv6, armel, arm64, loongarch64, riscv32, riscv64, s390x, ppc64le and wasm."
          exit 1
          ;;
      esac
      shift 2
